...
(() => {
    ...
    'zh-Hant': {
      ...
      heroLede: '專精於全端開發、 MarTech、API 整合與 AI 輔助開發，從釐清需求、開規格、寫程式、測試到上線，讓概念落地。',
      heroCtaProj: '查看專案',
    ...
    'en': {
      ...
      heroLede: 'Specializing in full-stack development, MarTech, API integration, and AI-assisted engineering—from scoping requirements and writing specs to development, testing, and deployment that bring concepts to life.',
